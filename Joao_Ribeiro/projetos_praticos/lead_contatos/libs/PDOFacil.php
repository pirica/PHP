<?php
    ...
    //         // Conexão
    //         $informacoes_banco = 
    //             "pgsql:Database={$this->nomeBancoDados};
...
private $senha = 'teknisa';


public function __construct(){ 
	$pdo = new PDO("pgsql:host=localhost;port=5432;dbname=postgres", 'postgres', 'teknisa', [PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION]);
	// echo "Conectado!";
}
